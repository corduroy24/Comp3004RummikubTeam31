...
public class TestP1 extends TestCase{
	...
	public void test2() {
		...
		p1.getHand().addTilesToHand(l1);
		p1.play();
		System.out.println(joker.getColor());
	...
	public void test8() {
		...
		Tile[] l1 = {joker,new Tile(1,13), new Tile(2,13),new Tile(3,13)};// use 2 joker to initial the first turn. 
		Player p1 = new Player("123",1,new p1());
		p1.getHand().addTilesToHand(l1);
	...
	public void test9() {
		...
		Tile[] l1 = {joker,new Tile(1,13), new Tile(2,13),
				new Tile(1,9), new Tile(1,10),new Tile(1,12)};// use 2 joker to initial the first turn. 
		Player p1 = new Player("123",1,new p1());
		p1.getHand().addTilesToHand(l1);
	...
	public void test10() {
		...
		Tile[] l1 = {joker,new Tile(1,13), new Tile(2,13),
				new Tile(1,6), new Tile(1,7),new Tile(1,9)};// use 2 joker to initial the first turn. 
		Player p1 = new Player("123",1,new p1());
		p1.getHand().addTilesToHand(l1);
